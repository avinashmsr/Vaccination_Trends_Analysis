/*CURRENT WORKING QUERY - No need to sum the columns as they already have cumulative values*/
/*So have to consider only the row with vaccination date 2021-10-25 for our 2 states - CO, PA*/
SELECT 
Location,
...
WHERE
    vaccination_date = '2021-10-25' and Location='PA';
...
FROM
    dbm_final_proj_group1.us_vaccination_data
WHERE
    vaccination_date = '2021-10-25' and Location='CO';

/*PREVIOUS QUERY - get end of month latest value and sum the columns to get the total by each brand*/
/*Group by Location attribute */
SELECT 
Location,
